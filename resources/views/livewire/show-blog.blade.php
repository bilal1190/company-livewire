                                        ...
                                        <article class="blog-post">
                                            <div class="post-slider slider-sm rounded">
                                                ...
                                                <a wire:navigate href="{{ route('blogdetail', $article->id) }}" >
                                                    <img class="img-fluid shadow-lg hover-effect" loading="lazy" decoding="async"
                                            ...
                                            <div class="pt-4">
                                                <p class="mb-3">
                                                    {{ \Carbon\Carbon::parse($article->creared_at)->format('d M, Y') }}
                                                </p>
                                                <h2 class="h4"> <a wire:navigate class="text-black"
                                                        href="{{ route('blogdetail', $article->id) }}">{{ $article->title }}</a></h2>
                                               <a wire:navigate href="{{ route('blogdetail', $article->id) }}" class="text-primary fw-bold"
                            ...
                            @foreach ($latestarticles as $latestarticle)
                                <ul class="list-unstyled widget-list">
                                    <li class="d-flex widget-post align-items-center">
                                        <a wire:navigate class="text-black" href="{{ route('blogdetail', $article->id) }}">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="h6 mb-0"><a wire:navigate class="text-black"
                                                    href="{{ route('blogdetail', $article->id) }}">{{ $latestarticle->title }}</a>
                                            </h5>
                                            <small>
                                                {{ \Carbon\Carbon::parse($latestarticle->creared_at)->format('d M, Y') }}</small>
                                        </div>
                                    </li>
                                </ul>
                            @endforeach
