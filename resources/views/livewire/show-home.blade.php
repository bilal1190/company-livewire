<main>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        <h1 class="text-capitalize mb-4">HFM Solutions!</h1>
                        <p class="mb-4">Unlocking Potential, Igniting Excellence Of You Bussiness</p> 
                ...
                <div class="col-lg-6">
                    <div class="ps-lg-5 text-center">
                        <img loading="lazy" decoding="async" src="{{ asset('frontend/images/home.png') }}"
 ...
 {{-- Counter --}}
 <div class="d-flex flex-row flex-wrap justify-content-center align-items-center mb-3 counter-container d-md-flex d-sm-grid">
 ...
 <div class="d-flex flex-row flex-wrap justify-content-center align-items-center mb-3 counter-container d-md-flex d-sm-grid">
    <div  class="p-2 bd-highlight">
        <img src="{{ asset('frontend/images/clients2.png') }}" alt="">
        <h1 class="counter">32</h1>
        <p>Posts</p>
    </div>
    <div  class="p-2 bd-highlight">
        <img src="{{ asset('frontend/images/projects2.png') }}" alt="">
        <h1 class="counter">2323</h1>
        <p>Posts</p>
    </div>
    <div  class="p-2 bd-highlight">
        <img src="{{ asset('frontend/images/team.png') }}" alt="">
        <h1 class="counter">2323</h1>
        <p>Posts</p>
    </div>
